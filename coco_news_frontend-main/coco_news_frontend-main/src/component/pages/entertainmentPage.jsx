...
const EntertainmentPage = () => {
  ...
  const API_URL = `https://newsapi.org/v2/top-headlines?category=entertainment&country=us&apiKey=${API_KEY}`
  ...
  return (
    <div>
      ...
      <main className={styles.politicsPage}>
        <h2 className={styles.sectionTitle}>Entertainment News</h2>
        {loading ? (
          <p>Loading...</p>
        ) : (
